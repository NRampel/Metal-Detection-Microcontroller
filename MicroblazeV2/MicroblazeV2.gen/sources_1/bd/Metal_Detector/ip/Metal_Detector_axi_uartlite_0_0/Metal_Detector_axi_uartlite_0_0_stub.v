...
//               c:/Metal-Detector-Firmware/MicroblazeV2/MicroblazeV2.gen/sources_1/bd/Metal_Detector/ip/Metal_Detector_axi_uartlite_0_0/Metal_Detector_axi_uartlite_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Metal_Detector_axi_uartlite_0_0,axi_uartlite,{}" *) (* core_generation_info = "Metal_Detector_axi_uartlite_0_0,axi_uartlite,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_uartlite,x_ipVersion=2.0,x_ipCoreRevision=39,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,C_FAMILY=artix7,C_S_AXI_ACLK_FREQ_HZ=100000000,C_S_AXI_ADDR_WIDTH=4,C_S_AXI_DATA_WIDTH=32,C_BAUDRATE=115200,C_DATA_BITS=8,C_USE_PARITY=0,C_ODD_PARITY=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_uartlite,Vivado 2025.2" *) 
module Metal_Detector_axi_uartlite_0_0(s_axi_aclk, s_axi_aresetn, interrupt, 
