...
#ifndef _Metal_Detector_xlconcat_0_0_core_h_
#define _Metal_Detector_xlconcat_0_0_core_h_
...
class Metal_Detector_xlconcat_0_0_core : public sc_module 
{
    public: 
       Metal_Detector_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(Metal_Detector_xlconcat_0_0_core);
    ...
    virtual ~Metal_Detector_xlconcat_0_0_core() = default;
