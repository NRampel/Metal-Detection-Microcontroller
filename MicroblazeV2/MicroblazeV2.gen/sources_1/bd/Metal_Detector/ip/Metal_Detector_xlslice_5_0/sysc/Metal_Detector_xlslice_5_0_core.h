...
#ifndef _Metal_Detector_xlslice_5_0_core_h_
#define _Metal_Detector_xlslice_5_0_core_h_

#include <systemc.h>
#include "properties.h"


class Metal_Detector_xlslice_5_0_core : public sc_module 
{
    public: 
       Metal_Detector_xlslice_5_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(Metal_Detector_xlslice_5_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~Metal_Detector_xlslice_5_0_core() = default;
