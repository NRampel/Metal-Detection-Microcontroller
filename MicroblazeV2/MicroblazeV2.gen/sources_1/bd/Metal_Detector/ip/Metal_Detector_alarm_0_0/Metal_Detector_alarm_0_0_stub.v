...
//               c:/Metal-Detector-Firmware/MicroblazeV2/MicroblazeV2.gen/sources_1/bd/Metal_Detector/ip/Metal_Detector_alarm_0_0/Metal_Detector_alarm_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Metal_Detector_alarm_0_0,alarm,{}" *) (* core_generation_info = "Metal_Detector_alarm_0_0,alarm,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=alarm,x_ipVersion=1.0,x_ipCoreRevision=4,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "alarm,Vivado 2025.2" *) 
module Metal_Detector_alarm_0_0(s00_axi_awaddr, s00_axi_awprot, 
